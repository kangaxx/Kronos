...
class Config:
    ...
    def __init__(self):
        ...
        self.test_time_range = ["2024-04-01", "2025-01-01"]
        self.backtest_time_range = ["2024-07-01", "2025-06-05"]

        # TODO: Directory to save the processed, pickled datasets.
        self.dataset_path = "/root/Kronos/finetune/data/processed_datasets"
        ...
        self.pretrained_tokenizer_path = "/root/my_tokenizer/Kronos-Tokenizer-base"
        self.pretrained_predictor_path = "/root/my_tokenizer/Kronos-Predictor-base"
        ...
        self.finetuned_tokenizer_path = "/root/my_tokenizer/Kronos-Tokenizer-base"
